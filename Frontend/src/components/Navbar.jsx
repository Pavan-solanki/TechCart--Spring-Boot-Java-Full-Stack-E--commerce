  ...
  return (
    <nav className="navbar navbar-expand-lg fixed-top bg-white shadow-sm" ref={navbarRef}>
      <div className="container-fluid">
        <a className="nav-link active" style={{display: "flex", alignItems: "center", fontWeight:"bold", fontSize:"1.5rem"}} aria-current="page" href="/" onClick={handleLinkClick}>
               <img style={{width: "50px", height: "50px"}} className="me-2" src={Unplugged} alt="" /> TechCart
              </a>
        <button
